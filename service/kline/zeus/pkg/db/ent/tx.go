...
func (tx *Tx) init() {
	tx.KPoint = NewKPointClient(tx.config)
	tx.KPrice = NewKPriceClient(tx.config)
	tx.Token = NewTokenClient(tx.config)
	tx.TokenPair = NewTokenPairClient(tx.config)
...
// applies a query, for example: KPoint.QueryXXX(), the query will be executed
