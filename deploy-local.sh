...
erc20_1_appid=`linera --with-wallet 10 create-application $erc20_bid --json-argument '{"initial_supply":"20000000","name":"Test Linera ERC20 Token","symbol":"TLA","decimals":18,"initial_currency":"0.00001", "fixed_currency":false, "fee_rate": "1"}'`
...
erc20_2_appid=`linera --with-wallet 11 create-application $erc20_bid --json-argument '{"initial_supply":"20000000","name":"Wrapper Testnet LINERA Token","symbol":"WTLINERA","decimals":18,"initial_currency":"1", "fixed_currency":true, "fee_rate": "1"}'`
