...
ams_appid=`linera --with-wallet 14 create-application $swap_bid \
...
swap_appid=`linera --with-wallet 12 create-application $swap_bid \
    --json-parameters '{"wlinera_application_id": "'$erc20_2_appid'","ams_application_id":"'$ams_appid'","logo":"","description":""}' \
    `
