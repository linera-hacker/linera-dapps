...
case $NETWORK_ID in
  1)
    WALLET_50_PUBLIC_IPORT='210.209.69.38:23111'
    LOCAL_IP='172.21.132.203'
    ;;
  2)
    WALLET_50_PUBLIC_IPORT='172.16.31.73:41160'
    LOCAL_IP='localhost'
    ;;
  3)
    WALLET_50_PUBLIC_IPORT='localhost:31140'
    LOCAL_IP='localhost'
    ;;
esac
...
wallet_50_default_chain=`linera --with-wallet 60 wallet show | grep "Public Key" | awk '{print $2}'`
wallet_50_owner=`linera --with-wallet 60 wallet show | grep "Owner" | awk '{print $4}'`
